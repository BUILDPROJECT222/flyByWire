// Adapted from Xenova/fruit-fly-simulation, MIT; see lab/licenses/neural-canvas.txt.
// This variant applies refractory periods to externally stimulated cells too.
